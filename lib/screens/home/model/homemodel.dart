...
//
//     final randomPerson = randomPersonFromJson(jsonString);

import 'dart:convert';

RandomPerson randomPersonFromJson(String str) => RandomPerson.fromJson(json.decode(str));

String randomPersonToJson(RandomPerson data) => json.encode(data.toJson());
...
class RandomPerson {
  ...
  factory RandomPerson.fromJson(Map<String, dynamic> json) => RandomPerson(
